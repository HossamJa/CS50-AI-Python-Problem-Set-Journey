...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        ...
        if mother is None and father is None:
            ...
            # Calculate probabilities from parents
            probs_from_parents = {}
            for parent, parent_name in [("mother", mother), ("father", father)]:
            ...
            if genes == 2:
                prob_gene = probs_from_parents["mother"] * probs_from_parents["father"]
            elif genes == 1:
                prob_gene = (probs_from_parents["mother"] * (1 - probs_from_parents["father"]) +
                             (1 - probs_from_parents["mother"]) * probs_from_parents["father"])
            else:
                prob_gene = (1 - probs_from_parents["mother"]) * (1 - probs_from_parents["father"])
